...
export const PROJECTS: Project[] = [
  ...
  { title: "Pearl Estate Lanka", category: "Luxury Real Estate", description: "A high-end property management platform for Sri Lanka's most distinguished homes — elegantly crafted with a gold & charcoal luxury aesthetic.", gradient: "from-amber-400 to-yellow-700", image: "/portfolio/pearlestate.png", liveUrl: "https://pearl-estate-lanka.vercel.app/" },
  ...
  { title: "KadeMart Superstore", category: "Hyper-local E-commerce", description: "A high-performance grocery delivery platform with real-time inventory and integrated logistics.", gradient: "from-green-500 to-emerald-400", image: "/portfolio/kademart.png", slug: "kademart", liveUrl: "https://kade-mart.vercel.app/" },
